...
class SeriesRepositoryImpl implements SeriesRepository {
  ...
  @override
  Future<Either<Failure, List<SeasonDetail>>> getSeriesSeasonDetail(int tvId, int seasonNumber) async {
    try {
      final result = await remoteDataSource.getSeriesSeasonDetail(tvId, seasonNumber);
      return Right(result.map((model) => model.toEntity()).toList());
    } on ServerException {
      return Left(ServerFailure(''));
    } on SocketException {
