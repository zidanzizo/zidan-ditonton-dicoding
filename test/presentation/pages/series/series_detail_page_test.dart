...
void main() {
  ...
  testWidgets('Watchlist button should display add icon when series not added to watchlist', (WidgetTester tester) async {
  ...
  testWidgets('Watchlist button should dispay check icon when series is added to wathclist', (WidgetTester tester) async {
    when(mockNotifier.seriesState).thenReturn(RequestState.Loaded);
    when(mockNotifier.series).thenReturn(testSeriesDetail);
    when(mockNotifier.recommendationState).thenReturn(RequestState.Loaded);
    when(mockNotifier.seriesRecommendations).thenReturn(<Series>[]);
  ...
  // testWidgets('list of season in series detail', (WidgetTester tester) async {
  //   when(mockNotifier.seriesState).thenReturn(RequestState.Loaded);
  //   when(mockNotifier.series).thenReturn(testSeriesDetail);
  //   when(mockNotifier.recommendationState).thenReturn(RequestState.Loaded);
  //   when(mockNotifier.seriesRecommendations).thenReturn(<Series>[]);
  ...
  //   final watchlistButton = find.byType(ListView);
